const T = {
  ...
  "nav.resellers": { en: "👥 Resellers", ru: "👥 Реселлеры" },
  "reseller.title": { en: "Resellers", ru: "Реселлеры" },
  "reseller.add_btn": { en: "Add Reseller", ru: "Добавить реселлера" },
  "reseller.stat_total": { en: "Total Resellers", ru: "Всего реселлеров" },
  "reseller.stat_balance": { en: "Total Balance", ru: "Общий баланс" },
  "reseller.stat_users": { en: "Users Created", ru: "Создано пользователей" },
  "reseller.stat_active": { en: "Active", ru: "Активных" },
  "reseller.name": { en: "Name", ru: "Имя" },
  "reseller.username": { en: "Username", ru: "Логин" },
  "reseller.balance": { en: "Balance", ru: "Баланс" },
  "reseller.commission": { en: "Commission", ru: "Комиссия" },
  "reseller.users": { en: "Users", ru: "Пользователи" },
  "reseller.status": { en: "Status", ru: "Статус" },
  "reseller.api_key": { en: "API Key", ru: "API ключ" },
  "reseller.actions": { en: "Actions", ru: "Действия" },
  "reseller.active": { en: "Active", ru: "Активен" },
  "reseller.inactive": { en: "Inactive", ru: "Неактивен" },
  "reseller.create_title": { en: "Create Reseller", ru: "Создать реселлера" },
  "reseller.edit_title": { en: "Edit Reseller", ru: "Редактировать реселлера" },
  "reseller.display_name": { en: "Display Name", ru: "Отображаемое имя" },
  "reseller.display_name_ph": { en: "My Reseller", ru: "Мой реселлер" },
  "reseller.commission_pct": { en: "Commission (%)", ru: "Комиссия (%)" },
  "reseller.max_users": { en: "Max Users", ru: "Макс. пользователей" },
  "reseller.initial_balance": { en: "Initial Balance (₽)", ru: "Начальный баланс (₽)" },
  "reseller.username_ph": { en: "reseller1", ru: "reseller1" },
  "reseller.cancel": { en: "Cancel", ru: "Отмена" },
  "reseller.save": { en: "Save", ru: "Сохранить" },
  "reseller.topup_title": { en: "Top-up Balance", ru: "Пополнить баланс" },
  "reseller.topup_amount": { en: "Amount (₽)", ru: "Сумма (₽)" },
  "reseller.topup_btn": { en: "Top-up", ru: "Пополнить" },
  "reseller.copy_key": { en: "Copy API Key", ru: "Копировать API ключ" },
  "reseller.created": { en: "Reseller created", ru: "Реселлер создан" },
  "reseller.updated": { en: "Reseller updated", ru: "Реселлер обновлён" },
  "reseller.deleted": { en: "Reseller deleted", ru: "Реселлер удалён" },
  "reseller.copied": { en: "API key copied!", ru: "API ключ скопирован!" },
  "reseller.topup_done": { en: "Balance topped up", ru: "Баланс пополнен" },
  "reseller.confirm_delete": { en: "Delete this reseller?", ru: "Удалить этого реселлера?" },
  "reseller.err_username": { en: "Username is required", ru: "Укажите логин" },
  "reseller.err_save": { en: "Save error", ru: "Ошибка сохранения" },
  "reseller.err_toggle": { en: "Toggle error", ru: "Ошибка переключения" },
  "reseller.err_delete": { en: "Delete error", ru: "Ошибка удаления" },
  "reseller.err_amount": { en: "Invalid amount", ru: "Неверная сумма" },
  "reseller.err_topup": { en: "Top-up error", ru: "Ошибка пополнения" },
  ...
  "srv.title": { en: "Servers", ru: "Серверы" },
  "srv.add_btn": { en: "Add Server", ru: "Добавить сервер" },
  "srv.stat_total": { en: "Total Servers", ru: "Всего серверов" },
  "srv.stat_online": { en: "Online", ru: "Онлайн" },
  "srv.stat_offline": { en: "Offline", ru: "Оффлайн" },
  "srv.stat_users": { en: "Total Users", ru: "Всего пользователей" },
  "srv.name": { en: "Name", ru: "Название" },
  "srv.status": { en: "Status", ru: "Статус" },
  "srv.country": { en: "Country", ru: "Страна" },
  "srv.users": { en: "Users", ru: "Пользователи" },
  "srv.bandwidth": { en: "Bandwidth", ru: "Трафик" },
  "srv.last_check": { en: "Last Check", ru: "Последняя проверка" },
  "srv.master": { en: "Master", ru: "Основной" },
  "srv.actions": { en: "Actions", ru: "Действия" },
  "srv.online": { en: "Online", ru: "Онлайн" },
  "srv.offline": { en: "Offline", ru: "Оффлайн" },
  "srv.create_title": { en: "Add Server", ru: "Добавить сервер" },
  "srv.edit_title": { en: "Edit Server", ru: "Редактировать сервер" },
  "srv.url": { en: "Marzban URL", ru: "Marzban URL" },
  "srv.url_ph": { en: "https://marzban.example.com", ru: "https://marzban.example.com" },
  "srv.username": { en: "Username", ru: "Пользователь" },
  "srv.password": { en: "Password", ru: "Пароль" },
  "srv.city": { en: "City", ru: "Город" },
  "srv.ip_address": { en: "IP Address", ru: "IP-адрес" },
  "srv.max_users": { en: "Max Users", ru: "Макс. пользователей" },
  "srv.is_master": { en: "Master server (default)", ru: "Основной сервер (по умолчанию)" },
  "srv.cancel": { en: "Cancel", ru: "Отмена" },
  "srv.save": { en: "Save", ru: "Сохранить" },
  "srv.create": { en: "Add", ru: "Добавить" },
  "srv.health_check": { en: "Health Check", ru: "Проверка" },
  "srv.edit": { en: "Edit", ru: "Редактировать" },
  "srv.delete": { en: "Delete", ru: "Удалить" },
  "srv.stats": { en: "Stats", ru: "Статистика" },
  "srv.no_servers": { en: "No servers added yet", ru: "Серверы ещё не добавлены" },
  "srv.confirm_delete": { en: "Delete this server?", ru: "Удалить этот сервер?" },
  "srv.created": { en: "Server added", ru: "Сервер добавлен" },
  "srv.updated": { en: "Server updated", ru: "Сервер обновлён" },
  "srv.deleted": { en: "Server deleted", ru: "Сервер удалён" },
  "srv.health_done": { en: "Health check completed", ru: "Проверка завершена" },
  "srv.err_create": { en: "Add error", ru: "Ошибка добавления" },
  "srv.err_update": { en: "Update error", ru: "Ошибка обновления" },
  "srv.err_delete": { en: "Delete error", ru: "Ошибка удаления" },
  "srv.err_health": { en: "Health check error", ru: "Ошибка проверки" },
  "srv.auto_refresh": { en: "Auto-refresh every 30s", ru: "Автообновление каждые 30с" },
  ...
  // Auto-Scaling
  "nav.auto_scaling": { en: "🤖 Auto-Scaling", ru: "🤖 Авто-скейлинг" },
  "as.status_title": { en: "Current Status", ru: "Текущий статус" },
  "as.total_nodes": { en: "Total Nodes", ru: "Всего нод" },
  "as.active_nodes": { en: "Active", ru: "Активных" },
  "as.total_users": { en: "Total Users", ru: "Всего пользователей" },
  "as.avg_load": { en: "Avg Load", ru: "Средняя нагрузка" },
  "as.would_scale": { en: "Would scale up now:", ru: "Масштабировать сейчас:" },
  "as.dry_run": { en: "Dry Run", ru: "Тестовый запуск" },
  "as.policies_title": { en: "Scaling Policies", ru: "Политики масштабирования" },
  "as.add_policy": { en: "Add Policy", ru: "Добавить политику" },
  "as.no_policies": { en: "No scaling policies yet", ru: "Политик масштабирования пока нет" },
  "as.events_title": { en: "Scaling Events", ru: "События масштабирования" },
  "as.ev.date": { en: "Date", ru: "Дата" },
  "as.ev.action": { en: "Action", ru: "Действие" },
  "as.ev.server": { en: "Server", ru: "Сервер" },
  "as.ev.status": { en: "Status", ru: "Статус" },
  "as.ev.details": { en: "Details", ru: "Детали" },
  "as.no_events": { en: "No events yet", ru: "Событий пока нет" },
  "as.create_policy": { en: "Create Policy", ru: "Создать политику" },
  "as.policy_name": { en: "Policy Name", ru: "Название" },
  "as.provider": { en: "Provider", ru: "Провайдер" },
  "as.api_token": { en: "API Token", ru: "API токен" },
  "as.server_type": { en: "Server Type", ru: "Тип сервера" },
  "as.region": { en: "Region", ru: "Регион" },
  "as.image_id": { en: "Image ID", ru: "ID образа" },
  "as.min_nodes": { en: "Min Nodes", ru: "Мин. нод" },
  "as.max_nodes": { en: "Max Nodes", ru: "Макс. нод" },
  "as.cooldown": { en: "Cooldown (min)", ru: "Кулдаун (мин)" },
  "as.threshold_cpu": { en: "CPU Threshold %", ru: "Порог CPU %" },
  "as.threshold_users": { en: "Users Threshold", ru: "Порог пользователей" },
  "as.threshold_bw": { en: "Bandwidth Threshold %", ru: "Порог трафика %" },
  "as.marzban_template": { en: "Marzban Template URL", ru: "URL шаблона Marzban" },
  "as.cancel": { en: "Cancel", ru: "Отмена" },
  "as.save": { en: "Save", ru: "Сохранить" },
};
